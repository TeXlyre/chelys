	...
	return (
		<form onSubmit={handleSubmit} className='profile-form'>
			...
			<p className='field-hint'>
				{t(
					'Open this link in a TeXlyre browser tab and log in with the same username and password to join this room. The link should be kept secret.',
				)}
			</p>
			<CopyField
			...
			{keyChanged && (
				<div className='warning-message'>
					<p>
						{rotatedKey
							? t(
									'A new key was generated but not saved yet. Saving switches you to an empty new room and leaves your current room the same.',
								)
							: t(
									'This key differs from your current one. Saving re-derives your room, so synced data will start from whatever is stored under the new room.',
								)}
					</p>
					<CopyField
